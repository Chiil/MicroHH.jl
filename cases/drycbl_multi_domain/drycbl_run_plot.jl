...
node11 = Observable(s_bot1 .- mean(s_bot1))
node12 = Observable(s1[:, 1, :] .- mean(s1, dims=(1, 2))[:, 1, :])
...
node21 = Observable(s_bot2 .- mean(s_bot2))
node22 = Observable(s2[:, 1, :] .- mean(s2, dims=(1, 2))[:, 1, :])
